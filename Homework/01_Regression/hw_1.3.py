...
x_train_set5 = np.empty([4521,  9], dtype=float)
x_validation5 = np.empty([1131, 9], dtype=float)

x_train_set5  = x_train_set[:, 9*9 : 10*9 ]
x_validation5 = x_validation[:, 9*9 : 10*9 ]

# print(x_train_set5[0,])
...
plt.plot(names2, values2, label="1 * 9")
plt.legend()
plt.show()
